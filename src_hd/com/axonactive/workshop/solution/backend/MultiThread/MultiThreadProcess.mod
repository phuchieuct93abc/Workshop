...
Ms0 f9 actionDecl 'com.axonactive.workshop.solution.backend.MultiThread.MultiThreadData out;
' #txt
Ms0 f9 actionTable 'out=in;
' #txt
Ms0 f9 actionCode 'in.totalTime = System.currentTimeMillis();' #txt
Ms0 f9 type com.axonactive.workshop.solution.backend.MultiThread.MultiThreadData #txt
...
Ms0 f15 actionDecl 'com.axonactive.workshop.solution.backend.MultiThread.MultiThreadData out;
' #txt
...
' #txt
Ms0 f15 type com.axonactive.workshop.solution.backend.MultiThread.MultiThreadData #txt
