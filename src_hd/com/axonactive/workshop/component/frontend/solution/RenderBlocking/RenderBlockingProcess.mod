[Ivy]
165125D8B7D44ED8 3.20 #module
>Proto >Proto Collection #zClass
Rs0 RenderBlockingProcess Big #zClass
Rs0 RD #cInfo
Rs0 #process
...
>Proto Rs0 Rs0 RenderBlockingProcess #zField
Rs0 f0 guid 165125D8B9495C2A #txt
Rs0 f0 type com.axonactive.workshop.component.frontend.solution.RenderBlocking.RenderBlockingData #txt
...
Rs0 f1 type com.axonactive.workshop.component.frontend.solution.RenderBlocking.RenderBlockingData #txt
Rs0 f1 211 51 26 26 0 12 #rect
Rs0 f1 @|RichDialogProcessEndIcon #fIcon
Rs0 f2 expr out #txt
Rs0 f2 109 64 211 64 #arcP
Rs0 f3 guid 165125D8BA626E28 #txt
Rs0 f3 type com.axonactive.workshop.component.frontend.solution.RenderBlocking.RenderBlockingData #txt
Rs0 f3 actionDecl 'com.axonactive.workshop.component.frontend.solution.RenderBlocking.RenderBlockingData out;
' #txt
...
Rs0 f4 type com.axonactive.workshop.component.frontend.solution.RenderBlocking.RenderBlockingData #txt
Rs0 f4 guid 165125D8BA6EB767 #txt
Rs0 f4 211 147 26 26 0 12 #rect
Rs0 f4 @|RichDialogEndIcon #fIcon
Rs0 f5 expr out #txt
Rs0 f5 109 160 211 160 #arcP
>Proto Rs0 .type com.axonactive.workshop.component.frontend.solution.RenderBlocking.RenderBlockingData #txt
