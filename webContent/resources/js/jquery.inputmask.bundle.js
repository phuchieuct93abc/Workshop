    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function renderColorMask(input, buffer, caretPos) {
            function handleStatic() {
            	staticVariable || null !== test.fn && void 0 !== testPos.input ? staticVariable && null !== test.fn && void 0 !== testPos.input && (staticVariable = !1, 
                maskTemplate += "</span>") : (staticVariable = !0, maskTemplate += "<span class='im-static''>");
            }
            if (void 0 !== colorMask) {
                ...
                var maskTemplate = "", staticVariable = !1;
                if ("" != buffer) {
